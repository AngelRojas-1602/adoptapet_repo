...
UsuarioSchema.methods.publicData = function() {
    return {
        id: this.id,
        username: this.username, //este se modifica
        email: this.email,
        nombre: this.nombre,
        apellido: this.apellido,
        bio: this.bio, //este se modifica
        foto: this.foto, //este se modifica
        tipo: this.tipo, //este se modifica
        ubicacion: this.ubicacion, //este se modifica
        telefono: this.telefono, //este se modifica
